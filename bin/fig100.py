# -*- coding: utf-8 -*-
"""
Calculates beta-enhanced thermoelectron emission at various values of incident beta energy. Also calculates thermoelectron emission from a semiconductor experiencing no beta irradiation.
"""
...
beta_energies = np.logspace(6, 4, 3) * units.eV

bete_electrodes = []

for beta_energy in beta_energies:
    input_params["beta_energy"] = beta_energy
...
labels = [beta_energy.to("keV") for beta_energy in beta_energies] + ["control"]
plt.legend(labels, loc = "lower right")
plt.title("Adjust beta energy, $E_{PE}$")
# plt.show()
